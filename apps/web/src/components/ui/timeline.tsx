...
import { useIsomorphicLayoutEffect } from '@cetus/web/hooks/use-isomorphic-layout-effect'
import { useLazyRef } from '@cetus/web/hooks/use-lazy-ref'
import { useComposedRefs } from '@cetus/web/shared/compose-refs'
...
function getSortedEntries(
  ...
  return entries.sort((a, b) => {
    ...
    // biome-ignore lint/suspicious/noBitwiseOperators: is needed
