        ...
        <div className="mx-auto max-w-7xl px-6">
          <div className="text-center">
            ...
            >
              ...
              órdenes en un solo lugar. Cetus te da las herramientas para vender
              sin complicaciones.
            </motion.p>
        ...
        <div className="grid grid-cols-1 items-center gap-16 md:grid-cols-2">
          ...
          >
            ...
            <p className="mt-4 text-lg text-muted-foreground">
              Configura tu e-commerce y empieza a vender en cuestión de minutos,
      ...
      <section className="mx-auto my-32 max-w-7xl px-6">
        ...
        >
          ...
          <p className="mx-auto mt-4 max-w-2xl text-lg text-muted-foreground">
            Crea tu cuenta gratis hoy mismo y descubre lo fácil que es tener tu
            propio e-commerce.
          </p>
