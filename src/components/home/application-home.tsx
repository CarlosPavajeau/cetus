...
export function ApplicationHome () {
  ...
  return (
    <main className="relative overflow-hidden">
      ...
      >
        <div
          className="absolute left-[-20%] top-[-10%] h-[36rem] w-[36rem] rounded-full bg-[radial-gradient(68.54%_68.72%_at_55.02%_31.46%,hsla(0,0%,85%,.10)_0,hsla(0,0%,55%,.04)_50%,hsla(0,0%,45%,0)_80%)] blur-3xl"/>
        <div
          className="absolute right-[-25%] top-[10%] h-[30rem] w-[30rem] rounded-full bg-[radial-gradient(50%_50%_at_50%_50%,hsla(0,0%,85%,.08)_0,hsla(0,0%,45%,.03)_80%,transparent_100%)] blur-2xl"/>
        <div
          className="absolute bottom-[-20%] left-1/2 h-[28rem] w-[28rem] -translate-x-1/2 rounded-full bg-[radial-gradient(50%_50%_at_50%_50%,hsla(0,0%,85%,.06)_0,hsla(0,0%,45%,.02)_80%,transparent_100%)] blur-2xl"/>
      </div>
          ...
          <div className="mx-auto max-w-7xl px-6">
            <div className="text-center sm:mx-auto lg:mt-0 lg:mr-auto">
              ...
              >
                ...
                minutos. Crea tu
                catálogo, gestiona inventario y cobra con MercadoPago desde un
                sistema ágil y
                económico.
              </motion.p>
              ...
              >
                ...
                <span className="text-sm text-muted-foreground">Sin tarjeta, cancela cuando quieras</span>
              </motion.div>
              ...
              >
                <div
                  className="h-full w-full rounded bg-[linear-gradient(180deg,hsla(0,0%,100%,.06),transparent)]"/>
              </motion.div>
            </div>
          </div>
        </div>
          ...
          {[
            {
              ...
              desc:
                'Publica productos, personaliza tu marca y abre tu tienda sin conocimientos técnicos.',
            },
            {
              title: 'Pagos seguros',
              desc:
                'Integra MercadoPago en un clic y ofrece cuotas, pagos con tarjeta o efectivo.',
            },
            {
              title: 'Gestión simple',
              desc:
                'Controla inventario, pedidos y envíos desde un panel moderno y veloz.',
            },
          ].map((item, idx) => (
            <motion.div
              key={item.title}
      ...
      <section className="mx-auto mt-24 max-w-7xl px-6">
        <div className="grid grid-cols-1 items-start gap-10 md:grid-cols-2">
          ...
          >
            <div
              className="h-full w-full rounded bg-[repeating-linear-gradient(135deg,transparent,transparent_12px,hsla(0,0%,100%,.05)_12px,hsla(0,0%,100%,.05)_24px)]"/>
          </motion.div>
        </div>
      </section>
      ...
      <section className="mx-auto mt-24 max-w-7xl px-6">
        ...
        >
          <h2 className="font-heading text-2xl">Integraciones listas para
            usar</h2>
      ...
      <section className="mx-auto my-28 max-w-7xl px-6">
        ...
        >
          ...
          <h2 className="font-heading text-2xl md:text-4xl">Empieza a vender
            hoy</h2>
